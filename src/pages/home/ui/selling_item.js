        ...
        fetch(url, {
            ...
            .then(data => {
                if(data=="cancel success")
                {
                    ...
                    scene.inventory.addItem(new Item('Crops', this.sellingInfo.item.item_name, this.sellingInfo.item.item_name, this.sellingInfo.item.item_name,this.sellingInfo.item_count))
